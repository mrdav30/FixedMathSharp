...
public readonly struct FixedMassPoint
{
    ...
    public static FixedMassPoint FromPoint(Vector3d point) =>
    ...
    /// </exception>
    public static FixedMassPoint CreateScaledLocalComposition(
        Vector3d outerPoint,
        Vector3d outerScale,
        ...
        FixedQuaternion innerRotation)
    {
        ...
        return WideMassProperties.CreatePoint(
            outerPoint,
            outerScale,
            innerOffset,
            innerScale,
    ...
    /// </summary>
    public bool TryAddParallelAxisTensor(
        Fixed3x3 centerTensor,
        Fixed64 mass,
        Vector3d referencePoint,
        out Fixed3x3 tensor) =>
        WideMassProperties.TryAddParallelAxisTensor(
            this,
            centerTensor,
            mass,
            referencePoint,
