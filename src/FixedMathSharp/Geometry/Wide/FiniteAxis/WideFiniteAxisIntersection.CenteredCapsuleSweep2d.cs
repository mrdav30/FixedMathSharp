...
internal static partial class WideFiniteAxisIntersection
{
    ...
    private static Vector2d GetAxisSweepFallbackNormal(
        ...
        Signed192 velocityY)
    {
        Vector2d edgeDirection = WideNormalization.GetNormalized(
        ...
        if (normal == Vector2d.Zero)
            normal = WideNormalization.GetNormalized(velocityX, velocityY);
        ...
        WideAxis2d target)
    {
        ...
        Signed320 closestY = Signed320.NarrowValue(WideArithmetic.SubtractSigned576(
            ...
            WideArithmetic.MultiplySigned320(
                ...
                deltaSquared)));
        return WideNormalization.GetNormalized(closestX, closestY);
    }
