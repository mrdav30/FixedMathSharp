...
internal static partial class WideFiniteAxisIntersection
{
        ...
        out FixedContactAnchors2d contact)
    {
        ...
        Vector2d normal = WideNormalization.GetNormalized(
        ...
        out FixedContactAnchors contact)
    {
        ...
        Vector3d firstLocalRadialDirection = WideNormalization.GetNormalized(
            firstRotation.Inverse().Rotate(normal));
        Vector3d secondLocalRadialDirection = WideNormalization.GetNormalized(
