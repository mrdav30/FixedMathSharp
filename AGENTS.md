...
| [`src/FixedMathSharp/Geometry`](src/FixedMathSharp/Geometry) | Bounds and primitive geometry | Includes `FixedBoundBox`, `FixedBoundSphere`, `FixedBoundArea`, `FixedBoundFrustum`, `FixedRay`, and `FixedPlane`. |
